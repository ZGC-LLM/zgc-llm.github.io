...
吸收 Linear/Supabase 的精密暗色手法，新增两项全站能力——**light/dark 双主题**与**中英双语切换**——
...
- [ ] **网络安全生态**（内容口径：**厂商中立**，面向"自主大模型"而非单一厂商；**仅点名已授权牵头方**，受邀企业只用角色描述，不放具体数字/个人姓名）：
  ...
  - **组织机制**（6 卡，点名已授权牵头方）：联盟统筹 · 智谱模型技术牵引（对不同厂商对等开放）· 清华网络与信息安全实验室学术指导 · 数说安全 & 云起无垠联合运营 · 生态伙伴共建 · 监管协同。⚠️ 上线前须确认各牵头方公开授权；未授权者改回角色描述。
...
- **网络安全页牵头方授权**：组织机制点名的智谱、清华网络与信息安全实验室、数说安全、云起无垠须确认已获**公开授权**；未授权者上线前改回角色描述。
